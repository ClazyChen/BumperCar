...
-- hs	=>  Location: PIN_W26,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- vs	=>  Location: PIN_W25,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- r[0]	=>  Location: PIN_V25,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- r[1]	=>  Location: PIN_V26,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- r[2]	=>  Location: PIN_U22,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- g[0]	=>  Location: PIN_V24,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- g[1]	=>  Location: PIN_V23,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- g[2]	=>  Location: PIN_Y25,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- b[0]	=>  Location: PIN_Y26,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- b[1]	=>  Location: PIN_W24,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- b[2]	=>  Location: PIN_W23,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- test_out[0]	=>  Location: PIN_AC16,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- test_out[1]	=>  Location: PIN_AD3,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- test_out[2]	=>  Location: PIN_AA2,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- test_out[3]	=>  Location: PIN_M4,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- test_out[4]	=>  Location: PIN_J4,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- test_out[5]	=>  Location: PIN_H4,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- test_out[6]	=>  Location: PIN_G6,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- test_out[7]	=>  Location: PIN_D19,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- data_key	=>  Location: PIN_C13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- clk	=>  Location: PIN_P4,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \u1|vx~0_combout\ = (!\u1|vx\(0)) # (!\u1|vx\(1))
...
-- Location: LCCOMB_X93_Y12_N30
\u1|Equal0~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \u1|Equal0~1_combout\ = (\u1|vx\(4) & (!\u1|vx\(7) & (\u1|vx\(3) & \u1|vx\(2))))
...
-- Equation(s):
-- \u1|Equal0~2_combout\ = (\u1|vx\(0) & (\u1|vx\(1) & (\u1|Equal0~0_combout\ & \u1|Equal0~1_combout\)))
...
-- Location: LCCOMB_X93_Y12_N28
\u1|vx~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \u1|vx~1_combout\ = (\u1|Add0~10_combout\ & ((\u1|vx~0_combout\) # ((!\u1|Equal0~0_combout\) # (!\u1|Equal0~1_combout\))))
...
-- Equation(s):
-- \u1|process_4~1_combout\ = (\u1|process_4~0_combout\ & ((\u1|vx\(6) & ((!\u1|vx\(5)) # (!\u1|vx\(4)))) # (!\u1|vx\(6) & ((\u1|vx\(4)) # (\u1|vx\(5))))))
...
-- Equation(s):
-- \u1|vy[8]~22_combout\ = \u1|vy\(8) $ (\u1|vy[7]~21\)
...
-- Equation(s):
-- \u1|process_5~1_combout\ = (((!\u1|vy\(7)) # (!\u1|vy\(8))) # (!\u1|vy\(5))) # (!\u1|vy\(6))
...
-- Equation(s):
-- \u1|process_5~0_combout\ = (\u1|vy\(4)) # ((\u1|vy\(2)) # ((!\u1|vy\(1)) # (!\u1|vy\(3))))
